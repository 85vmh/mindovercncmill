...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/x_plus_jog_button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.x_plus_jogbutton.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/y_minus_jog_button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.y_minus_jogbutton.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/z_minus_jog_button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.z_minus_jogbutton.setIcon(icon5)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/a_minus_jog_button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.a_minus_jogbutton.setIcon(icon7)
        ...
        self.jogincrement = JogIncrementWidget(self.page_3)
...
"")
        ...
        self.stackedWidgetLeftTop.addWidget(self.page_3)
        ...
        self.stackedWidgetLeftTop.addWidget(self.page_4)
        self.page_8 = QtWidgets.QWidget()
        self.page_8.setObjectName("page_8")
        self.gcodeeditor_final = GcodeEditor(self.page_8)
        ...
        self.recentfilecombobox = RecentFileComboBox(self.page_8)
...
"}")
        ...
        self.change_program_button = QtWidgets.QPushButton(self.page_8)
...
"}")
        ...
        self.reload_program_button = QtWidgets.QPushButton(self.page_8)
...
"}")
        ...
        self.stackedWidgetLeftTop.addWidget(self.page_8)
...
"}")
        ...
        self.probecodebuilderbutton = ProbeCodeBuilderButton(self.page_5)
        self.probecodebuilderbutton.setGeometry(QtCore.QRect(100, 160, 116, 36))
        self.probecodebuilderbutton.setObjectName("probecodebuilderbutton")
...
"}")
        ...
        self.axisactionbutton_2 = ActionButton(self.frame_dro_zone)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.axisactionbutton_2.setMinimumSize(QtCore.QSize(60, 35))
...
"}")
        ...
        self.frame_28.setGeometry(QtCore.QRect(90, 45, 68, 38))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.m6g43.setGeometry(QtCore.QRect(70, 135, 106, 40))
...
"}")
        ...
        self.vtkbackplot = VTKBackPlot(self.page_mainScreen)
        self.vtkbackplot.setEnabled(True)
        self.vtkbackplot.setGeometry(QtCore.QRect(570, 5, 694, 428))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.vtkbackplot.sizePolicy().hasHeightForWidth())
        self.vtkbackplot.setSizePolicy(sizePolicy)
        self.vtkbackplot.setMinimumSize(QtCore.QSize(694, 428))
        self.vtkbackplot.setMaximumSize(QtCore.QSize(16777215, 400))
...
"}")
        ...
        self.frame_5.setGeometry(QtCore.QRect(5, 5, 491, 41))
...
"}")
        ...
        self.statuslabel_17.setGeometry(QtCore.QRect(60, 5, 400, 20))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.statuslabel_17.setMinimumSize(QtCore.QSize(400, 0))
...
"}")
        ...
        self.statuslabel_18.setGeometry(QtCore.QRect(60, 20, 400, 20))
        self.statuslabel_18.setMinimumSize(QtCore.QSize(400, 0))
...
"}")
        ...
        self.statuslabel_32.setGeometry(QtCore.QRect(10, 15, 181, 21))
...
"}")
        ...
        self.frame_36 = QtWidgets.QFrame(self.page_selectProgram)
        self.frame_36.setGeometry(QtCore.QRect(770, 5, 491, 646))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.gcodeeditor_initial = GcodeEditor(self.page_9)
        ...
        self.verticalLayout_50.addWidget(self.gcodeeditor_initial)
...
"}")
        ...
        self.btnLoadGCode.setGeometry(QtCore.QRect(950, 675, 150, 35))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.tabWidget = QtWidgets.QTabWidget(self.page_offsetsScreen)
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 1156, 726))
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.frame_37 = QtWidgets.QFrame(self.tab)
        self.frame_37.setGeometry(QtCore.QRect(165, 45, 545, 500))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.stackedWidget = VCPStackedWidget(self.tab_2)
        self.stackedWidget.setGeometry(QtCore.QRect(5, 5, 1091, 616))
        ...
        self.label_2.setGeometry(QtCore.QRect(210, 170, 361, 56))
        ...
        self.widget_40 = QtWidgets.QWidget(self.page_selectProbeOperation)
        self.widget_40.setGeometry(QtCore.QRect(40, 40, 280, 280))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.widget_40.sizePolicy().hasHeightForWidth())
        self.widget_40.setSizePolicy(sizePolicy)
        self.widget_40.setMinimumSize(QtCore.QSize(280, 280))
        self.widget_40.setMaximumSize(QtCore.QSize(280, 280))
        ...
        self.probe_back_left_top_corner.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_back_left_top_corner.setMaximumSize(QtCore.QSize(80, 80))
        self.probe_back_left_top_corner.setFocusPolicy(QtCore.Qt.NoFocus)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/images/back_left_outside_corner.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.probe_back_left_top_corner.setIcon(icon17)
        self.probe_back_left_top_corner.setIconSize(QtCore.QSize(75, 75))
        ...
        self.probe_back_right_top_corner.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_back_right_top_corner.setMaximumSize(QtCore.QSize(80, 80))
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/images/back_right_outside_corner.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.probe_back_right_top_corner.setIcon(icon18)
        self.probe_back_right_top_corner.setIconSize(QtCore.QSize(75, 75))
        ...
        self.probe_right_top_side.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_right_top_side.setMaximumSize(QtCore.QSize(80, 80))
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/images/right_side_edge.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon19.addPixmap(QtGui.QPixmap(":/images/right_side_edge.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.probe_right_top_side.setIcon(icon19)
        self.probe_right_top_side.setIconSize(QtCore.QSize(75, 75))
        ...
        self.probe_z_minus_wco_edge.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_z_minus_wco_edge.setMaximumSize(QtCore.QSize(80, 80))
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/images/z_top.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.probe_z_minus_wco_edge.setIcon(icon20)
        self.probe_z_minus_wco_edge.setIconSize(QtCore.QSize(75, 75))
        ...
        self.probe_front_top_side.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_front_top_side.setMaximumSize(QtCore.QSize(80, 80))
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/images/front_middle_edge.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.probe_front_top_side.setIcon(icon21)
        self.probe_front_top_side.setIconSize(QtCore.QSize(75, 75))
        ...
        self.probe_back_top_side.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_back_top_side.setMaximumSize(QtCore.QSize(80, 80))
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/images/back_middle_outside_edge.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.probe_back_top_side.setIcon(icon22)
        self.probe_back_top_side.setIconSize(QtCore.QSize(75, 75))
        ...
        self.probe_front_left_top_corner.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_front_left_top_corner.setMaximumSize(QtCore.QSize(80, 80))
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/images/front_left_outside_corner.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.probe_front_left_top_corner.setIcon(icon23)
        self.probe_front_left_top_corner.setIconSize(QtCore.QSize(75, 75))
        ...
        self.probe_front_right_top_corner.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_front_right_top_corner.setMaximumSize(QtCore.QSize(80, 80))
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/images/front_right_outside_corner.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.probe_front_right_top_corner.setIcon(icon24)
        self.probe_front_right_top_corner.setIconSize(QtCore.QSize(75, 75))
        ...
        self.probe_left_top_side.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_left_top_side.setMaximumSize(QtCore.QSize(80, 80))
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/images/left_side_edge.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.probe_left_top_side.setIcon(icon25)
        self.probe_left_top_side.setIconSize(QtCore.QSize(75, 75))
        self.probe_left_top_side.setObjectName("probe_left_top_side")
        self.gridLayout_7.addWidget(self.probe_left_top_side, 1, 0, 1, 1)
        self.probe_back_right_top_corner_2 = SubCallButton(self.page_selectProbeOperation)
        self.probe_back_right_top_corner_2.setGeometry(QtCore.QRect(375, 340, 80, 80))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.probe_back_right_top_corner_2.sizePolicy().hasHeightForWidth())
        self.probe_back_right_top_corner_2.setSizePolicy(sizePolicy)
        self.probe_back_right_top_corner_2.setMinimumSize(QtCore.QSize(80, 80))
        self.probe_back_right_top_corner_2.setMaximumSize(QtCore.QSize(80, 80))
        self.probe_back_right_top_corner_2.setFocusPolicy(QtCore.Qt.NoFocus)
        self.probe_back_right_top_corner_2.setStyleSheet("")
        self.probe_back_right_top_corner_2.setText("")
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/probe_icons/X+Y-.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.probe_back_right_top_corner_2.setIcon(icon26)
        self.probe_back_right_top_corner_2.setIconSize(QtCore.QSize(75, 75))
        self.probe_back_right_top_corner_2.setObjectName("probe_back_right_top_corner_2")
        ...
        self.x_view_button.clicked.connect(self.vtkbackplot.setViewY)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.probecodebuilderbutton.setProperty("filename", _translate("MainWindow", "probe_round_boss.ngc"))
...
"]"))
        ...
        self.axisactionbutton_2.setText(_translate("MainWindow", "REF A"))
        self.axisactionbutton_2.setProperty("actionName", _translate("MainWindow", "machine.home.axis:a"))
...
"Codes"))
        ...
        self.statuslabel_32.setProperty("rules", _translate("MainWindow", "[{\"channels\": [{\"url\": \"settings:machine.jog.linear-speed\", \"trigger\": true}, {\"url\": \"status:program_units?text\", \"trigger\": false}], \"property\": \"Text\", \"expression\": \"\'Linear Jog Speed: {:.0f}\'.format(ch[0])\", \"name\": \"Linear Jog Speed\"}]"))
...
"LEFT"))
        ...
        self.offset_table.setProperty("displayColumns", _translate("MainWindow", "XYZR"))
        self.x_axis_button_10.setText(_translate("MainWindow", "CLEAR SELECTED"))
        self.x_axis_button_11.setText(_translate("MainWindow", "CLEAR ALL"))
        self.x_axis_button_13.setText(_translate("MainWindow", "SAVE TABLE"))
        self.x_axis_button_14.setText(_translate("MainWindow", "RELOAD TABLE"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Manual WCS"))
        self.label.setText(_translate("MainWindow", "Load the probe tool into the spindle\n"
"and plug the cable"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p>Touch the tip of the probe to ensure it works properly</p></body></html>"))
        ...
        self.probe_back_right_top_corner_2.setProperty("filename", _translate("MainWindow", "probe_back_right_top_corner.ngc"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Probe WCS"))
...
from widgets.probe_code_builder_button import ProbeCodeBuilderButton
import resources_rc
