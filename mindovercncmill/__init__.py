...
"""Main entry point for MindOverCncMill.
...
Example:
    ...
    launch MindOverCncMill by saying::

        $ mindovercncmill --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='mindovercncmill',
                          vcp_name='MindOverCncMill',
