...
class ItemDelegate(QStyledItemDelegate):
    ...
    def __init__(self, columns):
        ...
        self.degree_decimals = 2
        self.metric_decimals = 3
        self.imperial_decimals = 4
    ...
    def createEditor(self, parent, option, index):
        ...
        if col in 'XYZABCUVWR':
            ...
            if col in 'ABCR':
                editor.setDecimals(self.degree_decimals)
            else:
...
class WcsOffsetsTable(QTableView):
    def __init__(self, parent=None):
        super(WcsOffsetsTable, self).__init__(parent)
    ...
    @Property(int)
    def degreeDecimals(self):
        return self.itemDelegate().degree_decimals

    @degreeDecimals.setter
    def pauseText(self, value):
        self.itemDelegate().degree_decimals = value

    @Property(int)
    def metricDecimals(self):
        return self.itemDelegate().metric_decimals

    @metricDecimals.setter
    def pauseText(self, value):
        self.itemDelegate().metric_decimals = value

    @Property(int)
    def imperialDecimals(self):
        return self.itemDelegate().imperial_decimals

    @imperialDecimals.setter
    def pauseText(self, value):
        self.itemDelegate().imperial_decimals = value
