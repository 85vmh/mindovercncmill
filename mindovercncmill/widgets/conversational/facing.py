...
class FacingOpWidget(ConversationalBaseWidget):
    def __init__(self, parent=None):
        super(FacingOpWidget, self).__init__(parent, 'facing_op.ui')
        ...
        self.btnCreateProgram.clicked.connect(self.on_post_to_file)
